...
import { IonicPage, NavController, ToastController, Events, NavParams } from 'ionic-angular';
...
/**
 * Generated class for the DemoUserRegisterPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-demo-user-register',
  templateUrl: 'demo-user-register.html',
})
export class DemoUserRegisterPage {
  authForm: FormGroup;
  ...
  constructor(
    ...
    this.authForm = formBuilder.group({
      ...
      LastName: [''],
      Email: [''],
      Mobile1: ['', Validators.compose([Validators.required, Validators.minLength(10), Validators.maxLength(10)])],
      Address: [''],
      Mobile2: ['']
  ...
  doLogin() {
    ...
    if (this.u.Email != '' && this.validateEmail(this.u.Email) == false) {
      this.user.ShowAlert('Please enter valid Email.')
    }


    if (this.u.FirstName == '' || this.u.Mobile1 == '') {
    ...
    loading.present();
    this.user.DemoUserRegister(this.u).subscribe((resp: any) => {
